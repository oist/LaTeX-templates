...
% if you have a cosupervisor, use \hogehoge{title=\thesistitle, name=\name, supervisor=\supervisor, cosupervidor=\cosupervisor, submissiondate=\submissiondate} instead.
