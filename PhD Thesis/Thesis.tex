...
\usepackage[xindy, toc, acronym, symbols, nonumberlist]{glossaries} % For automatically making lists of glossaries and acronyms
\usepackage{hyperref} % Adds clickable links at references
%\usepackage[xindy, toc, acronym, symbols, nonumberlist]{glossaries} % If you want glossaries to be clickable.
...
\input{Preamble/abbreviations} % Define abbreviations in Preamble/abbreviations.tex. If unnecessary, remove this line.
\input{Preamble/glossary} % Define glossaries in Preamble/glossary.tex. If unnecessary, remove this line.
\input{Preamble/nomenclature} % Define nomenclature in Preable/nomenclature.tex. If unnecessary, remove this line.
