...
This is the main file, the only one that needs to be compiled to build the thesis. Compile once with \LaTeX, once with BibTeX and finally twice with \LaTeX\ to get all the references right. At the top of this file, you can see \verb|\documentclass[final]{oist_thesis}|. When you submit a final version, do not modify it. When you submit a temporary version to the graduate school, use \verb|\documentclass{oist_thesis}| instead.

Let's go through each section and comment them briefly. The last section will emphasize the differences between PDF files compiled with \verb|\documentclass{oist_thesis}| and \verb|\documentclass[final]{oist_thesis}|.
...
There are two main differences between PDF files compiled with \verb|\documentclass{oist_thesis}| and \verb|\documentclass[final]{oist_thesis}|. 
