...
This is a practical guide into how to use this template, by explaining the role of the different options, \texttt{Temporary\_Thesis.tex} and  \texttt{Final\_Thesis.tex}, the main file to compile the temporary version of the thesis and the final version respectively.
